...
Note: This article will only focus on **zsh** itself. If you want to simply copy my computer configs (ALL OF THEM), you can refer to [*How to Set Up on A New Machine*](https://lyk-love.cn/2024/01/09/how-to-set-up-on-a-new-machine/).
...
3. Enable the update:
   ...
   The config file of powlevel10k generated by `p10k configure` is `~/.p10k.zsh`.

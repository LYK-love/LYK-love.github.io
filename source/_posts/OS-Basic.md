...
* x86, x86_64, amd64: x86是32位的. x86_64是x86的64位版本, amd64==x86_64
* arm, arm64和aarh64: arm是32位的. arm64是arm的64位版本, 并且arm64和aarh64合并了, 所以arm64 == aarh64.
  * M1的指令集就是arm64. 低功耗的移动设备和嵌入式设备基本也都是arm架构.
* 桌面级CPU基本都是64位的, 要么是x86_64, 要么是arm64. 所以我们常说的x86, arm其实指代的是它们的64位版本, 即x86_64和arm64.
